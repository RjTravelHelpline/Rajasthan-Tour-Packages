...
export const tourOverview = {
    ...
    content: (
        <>
            ...
            <p>Visit Udaipur, the City of Lakes, to enjoy the tranquillity of Lake Pichola, explore its magnificent City Palace, and experience its charming Saheliyon Ki Bari.
            </p>
