export const metadata = {
  ...
  description:
    'Experience Rajasthan Heritage Hotels with our Heritage Hotels Tour Packages. Feel the royal and historical touch of Rajasthan with Rajasthan Tour Packages now.',
  alternates: {
    canonical:
