...
import { FaEnvelope, FaFacebook, FaInstagram, FaTwitter, FaUser, FaWhatsapp } from 'react-icons/fa';
                    ...
                    <div className="row d-flex justify-content-center align-items-start px-0 w-100">
                        <div className="col-lg-8 col-md-12 col-sm-12 px-sm-0 px-md-0 px-lg-2">
                            ...
                            <div className="insider px-3 mt-3">
                                <h3 className='my-3 text-center text-capitalize fw-normal'>share this <span className="fw-bold">blog</span></h3>
                                <div className="col">
                                    <div className="bg-tertary-down rounded-4 py-4 social-icons d-flex justify-content-center gap-3">
                                        {/* Facebook */}
                                        <a
