...
const Agra = () => {
    ...
    const agra_tour_packages = packages.filter(
        (item) => item.destination && item.destination.includes('agra')
    );
                ...
                <div className="row d-flex justify-content-center align-items-center days-overview px-2">
                    <div className="col-12 col-lg-12 col-sm-12 px-3">
                        ...
                        <div className="w-100 insider section-offset mb-4" id="tour-packages">
                            ...
                            <PackagesSlider exploreAll={false} packages={agra_tour_packages} href='/agra-tour-packages' />
                        </div>
                        {/* cab rentals */}
