export const metadata = {
  ...
  description:
    'Start your Rajasthan Tour from Andhra Pradesh with Rajasthan Tour Packages. Enjoy an immersive experience of the royal palaces, historic forts, and vibrant culture.',
  alternates: {
    canonical:
