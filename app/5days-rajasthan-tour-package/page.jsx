export const metadata = {
    title: '05 days rajasthan tour package',
    description: "",
    alternates: {
        canonical: 'https://www.rajasthantourpackages.in/5days-rajasthan-tour-package',
    },
    openGraph: {
        title: '05 days rajasthan tour package',
        description: "",
    ...
    return (
        <>
            ...
            <div className="container-fluid py-4 bg-black text-white">
                <div className="row">
                    <h1 className="text-5">05 days rajasthan tour package</h1>
                </div>
            </div>
        </>
    );
