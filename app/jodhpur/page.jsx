...
import { about, excursions, fairandfestivals, museumsandart, restaurantsandmore, shopping, sightseeing } from "@/data/Destination Data/jodhpur";
...
const Jodhpur = () => {
  const sections = [
    { id: 'about', label: 'About Jodhpur' },
    { id: 'historical-attractions', label: 'Jodhpur Sightseeing' },
