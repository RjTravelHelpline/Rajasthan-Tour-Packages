...
import { destinationCovered, packageData, page_titles, tour_faqs, tour_highlights, tourItinerary, tourOverview, whatsapp_link } from "./data";
...
const Page = () => {
    ...
    const TourCost = tourCost.filter(
        (cost) => cost.duration === 8 && cost.package_name == '08 Days Rajasthan Budget Tour Package'
    );
    ...
    const _08Days = packages.filter(
        (pkg) =>
            pkg.nights === 7 &&
            pkg.days === 8 &&
            pkg.title !== 'Rajasthan Budget Tour'
    );
    ...
    return (
        <>
            ...
            {/* banner */}
            <HeroBanner backgroundImage='/Images/Banners/budget-tour.jpg' slides={page_titles} />
            {/* Tour overview */}
