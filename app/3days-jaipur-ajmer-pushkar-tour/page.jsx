...
import { destinationCovered, packageData, tourFaq, tourHighlights, tourItinerary, tourOverview } from "@/data/Days Data/_3DaysJaipurAjmerPushkarTourData";
                        ...
                        <Carousel.Caption>
                            <div className="days-banner-content">
                                ...
                                <h1 className="mb-4 text-capitalize w-100 fw-bold text-center text-white">
                                    ...
                                    03 days jaipur ajmer pushkar tour
                                </h1>
                            </div>
                        </Carousel.Caption>
                    </Carousel.Item>
