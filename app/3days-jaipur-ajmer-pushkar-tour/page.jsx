...
const Page = () => {
    ...
    const TourCost = tourCost.filter(
        (cost) => cost.duration === 3 && cost.package_name == '03 Days Jaipur Ajmer Pushkar Tour Package'
    );
    ...
    return (
        <>
            ...
            {/* banner */}
            <HeroBanner backgroundImage='/Images/Banners/jaipur-ajmer-pushkar-tour.jpg' slides={page_titles} />
            {/* Tour overview */}
