...
import { BiChevronRight, BiChevronDown, BiChevronR, BiChevronDownight, BiLogoTripAdvisor } from 'react-icons/bi';
                ...
                <div className="container">
                    <div className="row d-flex justify-content-start aiign-items-center footer-links py-4">
                        <div className="col-lg-3 col-md-6 col-sm-12 mb-4">
                            ...
                            <div className="footer-icon d-flex justify-content-start align-items-center gap-3 mt-3">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <p className='text-capitalize text-white web-title fw-bold'>useful links</p>
                            <hr />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <p className='text-capitalize text-white web-title fw-bold'>company insights</p>
                            <hr />
                            <div className='d-flex justify-content-center flex-column align-items-start gap-2'>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 mb-4">
                            ...
                            <div className='mt-2 d-flex flex-column align-items-start'>
                                <a href="tel:+91-9024337038" className='text-lowercase d-flex justify-content-center align-items-center anchor-link-u'>
                                    <span className='fs-4 me-2 color-tertary'><RiCustomerService2Line /></span>
                                    <span className='text-white opacity-50 fw-normal'>(+91)-9024337038</span>
                                </a>
                                <a href="https://wa.me/9166555888" target="_blank" className='text-lowercase d-flex justify-content-center align-items-center anchor-link-u'>
                                    <span className='fs-4 me-2'><RiWhatsappFill style={{ color: '#4AB060' }} /></span>
                                    <span className='text-white opacity-50 fw-normal'>(+91)-9024337038</span>
                                </a>
                                <a href="mailto:mail@rajasthantravelhelpline.com" className='text-lowercase d-flex justify-content-center align-items-center anchor-link-u'>
                                    <span className='fs-4 me-2 anchor-link-u'><MdMail style={{ color: '#FF3C3C' }} /></span>
                                    <span className='text-white opacity-50 fw-normal '>mail@rajasthantravelhelpline.com</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-12 mb-2">
                            <div className="d-flex gap-2 justify-content-lg-end justify-content-sm-start align-items-center">
                                <Link href="/privacy-policy" className='text-white opacity-25 fw-light font-min anchor-link-u-white'>
                                    privacy policy
                                </Link>
                                <span className='text-white opacity-25'>•</span>
                                <Link href="/terms-and-conditions" className='text-white opacity-25 fw-light font-min anchor-link-u-white'>
                                    terms & conditions
                                </Link>
                                <span className='text-white opacity-25'>•</span>
                                <Link href="/sitemap.xml" className='text-white opacity-25 fw-light font-min anchor-link-u-white'>
                                    sitemap
                                </Link>
                            </div>
                        </div>
