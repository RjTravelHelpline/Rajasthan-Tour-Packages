...
export const about = {
    content: [
        ...
        `Delhi has a long and checkered history, which goes back to the pre-Christian era. It has been the capital of great kingdoms of the Delhi Sultanate, the Mughals and British India and again of modern India. The architectural style, traditions, and the general manner of life of the city are evidently a result of history, including the more recent history of several decades.`,
    ...
    content: [
        {
            ...
            content: `Just a 3-4 hour drive from Delhi, Agra is famous for the Taj Mahal, a wonder of the world. The city also boasts historical sites like Agra Fort and Fatehpur Sikri, making it a must-visit for history enthusiasts.`
        },
        {
            day: 'Jaipur',
            title: 'the Pink City',
            content: `Jaipur, the capital of Rajasthan and a UNESCO World Heritage site, is renowned for its royal palaces, forts, and temples. Key attractions include Amer Fort, Hawa Mahal, and City Palace, making Jaipur a top excursion destination from Delhi.`
        },
        {
