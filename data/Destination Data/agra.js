    ...
    content: [
        {
            ...
            content: `The Taj Mahal, one of the world’s most famous monuments of love, was built by Shah Jahan in memory of his wife Mumtaz Mahal. Admire its exquisite inlay work and symmetry during a visit to this stunning white marble tomb.`,
            highlights: {
                points: [
                    ``,
                ],
        ...
        },
        {
            ...
            content: `Built by Emperor Akbar, Agra Fort is a UNESCO World Heritage site known for its impressive gates, courtyards, and palaces. This large red sandstone fort offers insights into Mughal architecture and culture.`,
            highlights: {
                points: [
                    ``,
                ],
...
export const museumsandart = {
    content: [
        ...
        },
        {
            ...
            content: `Known for its live performances, exhibitions, and art displays, the Kalakriti Cultural and Convention Center also hosts the popular show "Mohabbat the Taj," which depicts the love story of Shah Jahan and Mumtaz Mahal through music and dance. It’s a vibrant venue for experiencing Agra's cultural scene.`,
        },
    ],
};
...
export const excursions = {
    content: [
        ...
        },
        {
            ...
            content: `Located about 60 km from Agra, Bharatpur Bird Sanctuary, also known as Keoladeo National Park, is a UNESCO World Heritage site. It is home to over 600 bird species, making it a paradise for bird watchers, especially during the migration season.`,
        },
        {
            day: 'Gwalior Fort',
...
export const shopping = {
    content: [
        ...
        },
        {
            ...
            content: `Located off Jama Masjid, Kinari Bazaar is one of Agra's oldest markets, known for its specialty in jewelry, clothes, and fabrics. It’s a lively market for shopping occasions, offering bridal wear, exquisite embroidery, and handcrafted goods.`,
        },
        {
            day: 'TDI Mall',
