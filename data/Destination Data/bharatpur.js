...
export const sightseeing = {
  content: [
    ...
    },
    {
      ...
      content: `The Ganga Mandir, dedicated to the goddess Ganga, is one of the oldest temples in Bharatpur. Situated near Lohagarh Fort, this peaceful temple is known for its serene atmosphere and beautiful design. Devotees visit to seek blessings and experience the tranquility of the place.`,
      highlights: {
        points: [],
      },
    },
    ...
    },
    {
      ...
      content: `Deeg Palace, located 32 kilometers from Bharatpur, was built by Maharaja Suraj Mal. The palace is known for its well-maintained gardens, fountains, and beautiful architectural designs that blend Mughal and Rajasthani styles. The palace features various buildings, including the Shish Mahal (Glass Palace) and Sawan Bhadon, famous for the intricate work done on the structures.`,
      highlights: {
        points: [],
      },
    },
  ...
  content: [
    {
      ...
      content: `Located just 40 kilometers from Bharatpur, Mathura and Vrindavan are two of the most significant destinations for devotees of Lord Krishna. Mathura is believed to be the birthplace of Lord Krishna, while Vrindavan is home to numerous temples and sacred sites associated with his life. Visitors can explore ancient temples, participate in rituals, and immerse themselves in the spiritual atmosphere of these revered towns.`,
    },
    {
      day: 'Agra',
      title: 'exploring Mughal history and architectural marvels',
      content: `Situated just an hour’s drive from Bharatpur, Agra is famous for housing the Taj Mahal, one of the most iconic monuments in the world. Visitors can explore the majestic Taj Mahal, Agra Fort, and Fatehpur Sikri, all of which showcase the grandeur of Mughal architecture. Agra is a must-visit for history and architecture enthusiasts looking to immerse themselves in the rich heritage of India.`,
    },
    {
  ...
  content: [
    {
      ...
      content: `Dal Baati Churma is one of the most famous dishes in Rajasthan and a favorite among tourists in Bharatpur. This dish includes spicy wheat balls stuffed with mashed lentils (dal) and a dessert made of sweet crushed baatis mixed with ghee. It's a classic Rajasthani dish that perfectly represents the region's culinary indulgence.`,
    },
    {
      day: 'Gatte Ki Sabzi',
      title: 'gram flour dumplings in a tangy sauce',
      content: `Gatte Ki Sabzi is a rich and flavorful dish from Bharatpur. It features gram flour dumplings cooked in a spicy, tangy sauce, often accompanied by steamed rice or roti. Sometimes, it is served with a side dish called 'kilebo,' a local specialty that adds to the dish’s unique taste.`,
    },
    {
      day: 'Laal Maas',
      title: 'spicy lamb curry with a fiery kick',
      content: `Laal Maas is a fiery lamb curry made with red chilies, garlic, and a blend of spices, ideal for those with a love for spicy food. The dish's intense flavors and rich texture make it a must-try for those seeking authentic Rajasthani cuisine.`,
    },
    {
      day: 'Sweet Dishes',
    ...
    },
    {
      ...
      content: `For those who want to sample a variety of Rajasthani dishes at once, the Rajasthani Thali is the perfect choice. This meal includes dal, baati, sabzi, rice, chapati, and sweet items, offering a comprehensive experience of the region’s rich culinary traditions.`,
    },
  ],
};
  ...
  content: [
    {
      day: 'By Air',
      title: '',
      content: `The nearest airport is Agra Airport, about 55 km away. Alternatively, you can fly into Jaipur Airport (about 180 km from Bharatpur).`,
    },
    {
      day: 'By Train',
      title: '',
      content: `Bharatpur Junction is well-connected to cities like Delhi, Agra, and Jaipur. Several trains run from these cities to Bharatpur.`,
    },
    {
      day: 'By Road',
      title: '',
